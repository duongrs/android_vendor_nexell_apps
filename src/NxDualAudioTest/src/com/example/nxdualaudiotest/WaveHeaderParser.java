...
public class WaveHeaderParser {
    ...
    /**
     * Construct a WaveHeaderParser, with all fields defaulting to zero.
     */
    public WaveHeaderParser() {
    }
    
    /**
     * Construct a WaveHeaderParser, with fields initialized.
     ...
     */
    public WaveHeaderParser(short format, short numChannels, int sampleRate, short bitsPerSample, int numBytes) {
        mFormat = format;
     ...
     * @param format
     * one of {@link #FORMAT_PCM}, {@link #FORMAT_ULAW}, or {@link #FORMAT_ALAW}.
     * @return reference to this WaveHeaderParser instance.
     */
    public WaveHeaderParser setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this WaveHeaderParser instance.
     */
    public WaveHeaderParser setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this WaveHeaderParser instance.
     */
    public WaveHeaderParser setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this WaveHeaderParser instance.
     */
    public WaveHeaderParser setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this WaveHeaderParser instance.
     */
    public WaveHeaderParser setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }
    
    /**
     * Read and initialize a WaveHeaderParser.
    ...
    public String toString() {
        return String.format(
                "WaveHeaderParser format=%d numChannels=%d sampleRate=%d bitsPerSample=%d numBytes=%d",
